...
@Component({
    templateUrl: "./home-progressContent.component.html",
  animations: [appModuleAnimation()],
})
export class ProgressContentComponent extends PagedListingComponentBase<ContentDto> {
    banners: ContentDto[] = [];
  keyword = "";
  ...
  list(
    ...
    finishedCallback: () => void
      ...
      this._contentServiceProxy
          .getContentList(
        this.keyword,
              this.isActive ?? undefined, undefined,"Home_ProgressContent",
        request.skipCount,
