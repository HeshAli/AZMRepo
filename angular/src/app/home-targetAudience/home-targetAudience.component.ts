...
@Component({
    templateUrl: "./home-targetAudience.component.html",
  animations: [appModuleAnimation()],
})
export class TargetAudienceComponent extends PagedListingComponentBase<ContentDto> {
    banners: ContentDto[] = [];
  keyword = "";
  ...
  list(
    ...
    finishedCallback: () => void
      ...
      this._contentServiceProxy
          .getContentList(
        this.keyword,
              this.isActive ?? undefined, undefined,"Home_TargetAudience",
        request.skipCount,
  ...
  private showCreateOrEditBannerDialog(id?: number): void {
    ...
    if (!id) {
        modalRef = this._modalService.show(CreateTargetAudienceDialogComponent, {
        class: "modal-lg",
      });
    } else {
        modalRef = this._modalService.show(EditTargetAudienceDialogComponent, {
        class: "modal-lg",
        initialState: { id },
      });
    }
