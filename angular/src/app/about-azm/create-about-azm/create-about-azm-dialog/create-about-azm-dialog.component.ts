...
@Component({
    templateUrl: './create-about-azm-dialog.component.html'
})
export class CreateAboutAzmDialogComponent extends AppComponentBase
  implements OnInit {
    saving = false;
  ...
  save(): void {
    this.saving = true;
      this.content.categoryCode = "AboutAzm";
